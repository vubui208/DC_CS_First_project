...
clear_btn = ttk.Button(cart_outer, text="Clear Cart", style="Flat.TButton", takefocus=0, command=clear_cart)
clear_btn.pack(side="bottom", anchor="e", padx=10, pady=(0, 10))
